...
local middlePos = function()
  ...
  local pos = ballPos + Utils.Polar2Vector(590,idir)
  return pos
end
...
["start"] = {
  ...
  Kicker   = task.goCmuRush(middlePos,dir.playerToBall,500),
  Middle   = task.mydef(0.7,500),
  Tier     = task.goCmuRush(jqf1,dir.playerToBall,500),
  Goalie   = task.goalie(),
  Defender = task.goCmuRush(jqf2,dir.playerToBall,500),
 ...
 ["dq"] = {
  ...
  Kicker   = task.mydef(0.8,500),
  Middle   = task.goCmuRush(bx1,dir.playerToBall,500),
  Tier     = task.goCmuRush(rjf,dir.playerToBall,500),
  Goalie   = task.goalie(),
  Defender = task.goCmuRush(ljf,dir.playerToBall,500),
  Receiver = task.goCmuRush(bx2,dir.playerToBall,500),
   match = "{G}[KMTRD]"
 },
